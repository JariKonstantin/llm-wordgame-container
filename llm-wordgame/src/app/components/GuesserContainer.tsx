...
export default function GuesserContainer({
  roundData,
  guessInput,
  setGuessInput,
  solve,
  updateUsedHints,
}: GuesserContainerProps) {
    ...
    <div className="flex flex-col gap-4 p-6">
      <div className="flex flex-row justify-between">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-lg">
            {roundData.wordDescription ? roundData.wordDescription : <Spinner />}
          </p>
        </div>
        <div className="flex flex-col gap-4">
          <p className="text-lg font-bold">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Button
            variant={"gradient"}
            onClick={solve}
            disabled={roundData.roundState !== "playing"}
          >
            Try to solve (-1 points if incorrect)
          </Button>
        </div>
      </div>
      <div className="flex flex-col gap-4">
